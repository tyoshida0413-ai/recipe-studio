      ...
      <div className="modal-card" style={{ width: '600px', maxWidth: '95vw' }}>
        ...
        <div className="modal-body">
          ...
          <div style={{
            ...
            YouTubeの概要欄（「もっと見る」）から材料・分量・作り方テキストをコピーして下に貼り付けることで、<strong>動画通りの100%正確なレシピ</strong>が生成されます。<br />
            ※動画の実食シーンやトークで紹介されている味変（「からしを添えると最高」等）のメモも一緒に添えて貼り付けると、AIが「マイアレンジ・料理メモ」に忠実に反映します。
          </div>
